...
import com.pa.paperless.adapter.BaseAdapter;
...
public class NotationFileAdapter extends BaseAdapter {
    ...
    public NotationFileAdapter(Context context, List<MeetDirFileInfo> data) {
        super(context);
        mDatas = data;
    }
